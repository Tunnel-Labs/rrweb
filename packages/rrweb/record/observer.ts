...
import type { MutationBufferParam, observerParam } from '../types/_.js';
import {
	getWindowHeight,
	getWindowScroll,
	getWindowWidth,
...
import { callbackWrapper } from './error-handler.ts';
import MutationBuffer from './mutation.ts';
...
function initMoveObserver({
	...
	const threshold = typeof sampling.mousemove === 'number' ?
		sampling.mousemove :
		50;
